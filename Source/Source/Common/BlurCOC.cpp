...
BlurCOC::BlurCOC(ID3D12Device* device,
...
ID3D12Resource* BlurCOC::Output()
{
	return mBlurMap0.Get();
}

void BlurCOC::BuildDescriptors(CD3DX12_CPU_DESCRIPTOR_HANDLE hCpuDescriptor,
...
void BlurCOC::OnResize(UINT newWidth, UINT newHeight)
{
...
void BlurCOC::Execute(ID3D12GraphicsCommandList* cmdList,
...
std::vector<float> BlurCOC::CalcGaussWeights(float sigma)
{
